...
void Foam::functionObjects::potentialWallFlux::writeFileHeader(Ostream& os) const//void Foam::functionObjects::potentialWallFlux::writeFileHeader(const label i)
{
...
bool Foam::functionObjects::potentialWallFlux::execute()
{
    ...
    calcFlux(kf_, fi_, potentialWallFlux);
...
bool Foam::functionObjects::potentialWallFlux::write()
{
    ...
    const volScalarField& potentialWallFlux = lookupObject<volScalarField>(type());

    Log << type() << " " << name() << " write:" << nl
        << "    writing field " << potentialWallFlux.name() << endl;

    potentialWallFlux.write();
